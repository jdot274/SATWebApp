    ...
    <div className="fixed top-4 right-8 z-[100]">
      <div className="flex items-center gap-2">
        <button
          ...
          className="px-3 py-1.5 bg-gradient-to-r from-blue-600 to-blue-400
                   rounded-xl text-white font-medium shadow-lg hover:from-blue-500 hover:to-blue-300
        ...
        <button
          ...
          className="px-3 py-1.5 bg-gradient-to-r from-green-500 to-emerald-500 
