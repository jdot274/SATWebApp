...
import { BookOpen, Clock, Brain, Search, Filter } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex gap-4 mb-8">
            ...
            <button className="px-4 py-2 bg-white/5 border border-white/10 rounded-xl
                           text-white/90 hover:bg-white/10 transition-colors flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 gap-6">
            {mockReviewQuestions.map((question) => (
              ...
              >
                ...
                <h3 className="text-lg text-white/90 mb-4 line-clamp-3">{question.question}</h3>
