  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950">
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-4 py-8">
        {/* Welcome Section */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white/90">Welcome back, Joey!</h1>
          <p className="text-white/60 mt-2">Your test is in 45 days. Stay on track!</p>
        </div>
